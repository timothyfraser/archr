This tutorial complements `26_evaluation_system_reliability.R` and
unpacks the workshop on system reliability evaluation. You will see how
...
- Navigate the script `26_evaluation_system_reliability.R` within the
  Evaluation module.
- Connect the topic “System reliability evaluation” to systems
...
It creates `t`. My coffee shop’s system has 3 serially-connected
components: A = coffee maker (MTTF = 500 hours) B = bean grinder (MTTF =
5000 hours) C = dishwasher (MTTF = 1000 hours) What’s the probability
the system survives 100 hours?
