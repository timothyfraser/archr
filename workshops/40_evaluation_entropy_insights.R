# Script: 40_evaluation_entropy_insights.R
# Original: tutorial_tradespace_5.R
# Topic: Entropy and tradespace insights
# Section: Evaluation
...
# 0. SETUP ################################
# Load 00_entropy_utilities.R for h(), j(), i(), and ig()
