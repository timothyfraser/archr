...
1. Open `workshops/52_optimization_feature_experiments.R` in the Source pane and skim the header comments for context.
...
6. When you are comfortable, run `source(file.path("workshops", "52_optimization_feature_experiments.R"))` or click Source to execute the full workshop.
