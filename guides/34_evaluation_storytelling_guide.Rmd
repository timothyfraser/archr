...
**Learning Check 1.** What role does the helper `get_cost()` defined in Step 12 play in this workflow?
...
**Learning Check 2.** What role does the helper `get_performance()` defined in Step 41 play in this workflow?
