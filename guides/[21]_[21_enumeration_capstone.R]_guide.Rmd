...
1. Open `workshops/21_enumeration_capstone.R` in the Source pane and skim the header comments for context.
...
6. When you are comfortable, run `source(file.path("workshops", "21_enumeration_capstone.R"))` or click Source to execute the full workshop.
