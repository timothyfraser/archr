...
**Learning Check 2.** What role does the helper `get_benefit()` defined in Step 4 play in this workflow?
...
**Learning Check 3.** What role does the helper `get_reliability()` defined in Step 5 play in this workflow?
