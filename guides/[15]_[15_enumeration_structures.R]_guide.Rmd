...
1. Open `workshops/15_enumeration_structures.R` in the Source pane and skim the header comments for context.
...
7. When you are comfortable, run `source(file.path("workshops", "15_enumeration_structures.R"))` or click Source to execute the full workshop.
