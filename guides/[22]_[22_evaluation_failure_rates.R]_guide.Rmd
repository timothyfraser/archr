...
1. Open `workshops/22_evaluation_failure_rates.R` in the Source pane and skim the header comments for context.
...
6. When you are comfortable, run `source(file.path("workshops", "22_evaluation_failure_rates.R"))` or click Source to execute the full workshop.
