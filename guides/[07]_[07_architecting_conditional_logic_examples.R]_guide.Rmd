...
1. Open `workshops/07_architecting_conditional_logic_examples.R` in the Source pane and skim the header comments for context.
...
6. When you are comfortable, run `source(file.path("workshops", "07_architecting_conditional_logic_examples.R"))` or click Source to execute the full workshop.
