...
**Learning Check 1.** What role does the helper `me()` defined in Step 1 play in this workflow?
...
**Learning Check 2.** What role does the helper `sensitivity()` defined in Step 3 play in this workflow?
...
**Learning Check 3.** What role does the helper `me_ij()` defined in Step 7 play in this workflow?
...
**Learning Check 4.** What role does the helper `sensitivity_ij()` defined in Step 12 play in this workflow?
