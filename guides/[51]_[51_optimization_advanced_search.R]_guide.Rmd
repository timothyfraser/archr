...
1. Open `workshops/51_optimization_advanced_search.R` in the Source pane and skim the header comments for context.
...
6. When you are comfortable, run `source(file.path("workshops", "51_optimization_advanced_search.R"))` or click Source to execute the full workshop.
