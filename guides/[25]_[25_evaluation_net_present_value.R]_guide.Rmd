...
1. Open `workshops/25_evaluation_net_present_value.R` in the Source pane and skim the header comments for context.
...
6. When you are comfortable, run `source(file.path("workshops", "25_evaluation_net_present_value.R"))` or click Source to execute the full workshop.
