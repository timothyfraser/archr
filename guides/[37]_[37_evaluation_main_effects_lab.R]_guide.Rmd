...
1. Open `workshops/37_evaluation_main_effects_lab.R` in the Source pane and skim the header comments for context.
...
7. When you are comfortable, run `source(file.path("workshops", "37_evaluation_main_effects_lab.R"))` or click Source to execute the full workshop.
