...
**Learning Check 1.** What role does the helper `evaluate()` defined in Step 3 play in this workflow?
...
**Learning Check 2.** What role does the helper `int2bin()` defined in Step 9 play in this workflow?
...
**Learning Check 3.** What role does the helper `bin2int()` defined in Step 10 play in this workflow?
...
**Learning Check 4.** What role does the helper `revise_permutation()` defined in Step 12 play in this workflow?
