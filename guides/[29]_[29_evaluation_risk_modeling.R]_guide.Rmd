...
1. Open `workshops/29_evaluation_risk_modeling.R` in the Source pane and skim the header comments for context.
...
6. When you are comfortable, run `source(file.path("workshops", "29_evaluation_risk_modeling.R"))` or click Source to execute the full workshop.
