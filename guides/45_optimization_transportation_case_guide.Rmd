...
**Learning Check 2.** What role does the helper `get_riders()` defined in Step 7 play in this workflow?
...
**Learning Check 3.** What role does the helper `bit2int()` defined in Step 12 play in this workflow?
...
**Learning Check 4.** What role does the helper `f1()` defined in Step 13 play in this workflow?
