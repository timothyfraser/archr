...
1. Open `workshops/39_evaluation_pareto_prioritization.R` in the Source pane and skim the header comments for context.
...
7. When you are comfortable, run `source(file.path("workshops", "39_evaluation_pareto_prioritization.R"))` or click Source to execute the full workshop.
