...
1. Open `workshops/45_optimization_transportation_case.R` in the Source pane and skim the header comments for context.
...
7. When you are comfortable, run `source(file.path("workshops", "45_optimization_transportation_case.R"))` or click Source to execute the full workshop.
