...
**Learning Check 1.** What role does the helper `bit2int()` defined in Step 1 play in this workflow?
...
**Learning Check 2.** What role does the helper `revise_bit()` defined in Step 4 play in this workflow?
...
It creates `d1` that returns the assembled object, and threads the result through a dplyr pipeline. Create the object `d1` so you can reuse it in later steps.
