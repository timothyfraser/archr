...
1. Open `workshops/10_architecting_ahp_archr_demo.R` in the Source pane and skim the header comments for context.
...
7. When you are comfortable, run `source(file.path("workshops", "10_architecting_ahp_archr_demo.R"))` or click Source to execute the full workshop.
