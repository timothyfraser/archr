...
**Learning Check 1.** What role does the helper `get_plusone()` defined in Step 35 play in this workflow?
...
**Learning Check 2.** What role does the helper `get_cost()` defined in Step 42 play in this workflow?
...
**Learning Check 3.** What role does the helper `get_benefit()` defined in Step 46 play in this workflow?
