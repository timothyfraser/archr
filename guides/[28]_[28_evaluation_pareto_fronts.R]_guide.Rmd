...
1. Open `workshops/28_evaluation_pareto_fronts.R` in the Source pane and skim the header comments for context.
...
6. When you are comfortable, run `source(file.path("workshops", "28_evaluation_pareto_fronts.R"))` or click Source to execute the full workshop.
