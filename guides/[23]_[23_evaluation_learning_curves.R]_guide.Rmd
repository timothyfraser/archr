...
1. Open `workshops/23_evaluation_learning_curves.R` in the Source pane and skim the header comments for context.
...
6. When you are comfortable, run `source(file.path("workshops", "23_evaluation_learning_curves.R"))` or click Source to execute the full workshop.
