...
1. Open `workshops/16_enumeration_constraints.R` in the Source pane and skim the header comments for context.
...
5. When you are comfortable, run `source(file.path("workshops", "16_enumeration_constraints.R"))` or click Source to execute the full workshop.
