...
1. Open `workshops/11_architecting_simple_counting_function.R` in the Source pane and skim the header comments for context.
...
6. When you are comfortable, run `source(file.path("workshops", "11_architecting_simple_counting_function.R"))` or click Source to execute the full workshop.
