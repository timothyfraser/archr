...
1. Open `workshops/49_optimization_genetic_algorithms_intro.R` in the Source pane and skim the header comments for context.
...
6. Inspect the optimization configuration (population size, mutation rate) to see how they influence GA output.
7. When you are comfortable, run `source(file.path("workshops", "49_optimization_genetic_algorithms_intro.R"))` or click Source to execute the full workshop.
...
**Learning Check 5.** What GA configuration element should you review to understand how the optimization search proceeds?
