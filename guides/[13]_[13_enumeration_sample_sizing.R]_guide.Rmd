...
1. Open `workshops/13_enumeration_sample_sizing.R` in the Source pane and skim the header comments for context.
...
6. When you are comfortable, run `source(file.path("workshops", "13_enumeration_sample_sizing.R"))` or click Source to execute the full workshop.
