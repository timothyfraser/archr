...
1. Open `workshops/19_enumeration_filters.R` in the Source pane and skim the header comments for context.
...
6. Recreate the plotted visuals and experiment with aesthetic mappings to reinforce each layer.
7. When you are comfortable, run `source(file.path("workshops", "19_enumeration_filters.R"))` or click Source to execute the full workshop.
