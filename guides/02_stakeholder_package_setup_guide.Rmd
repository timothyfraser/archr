...
Step 1 installs dplyr, readr, tidyr, stringr, purrr, igraph, tidygraph, ggraph, ggplot2, viridis, ggpubr, GA, rmoo, texreg, broom and gtools, so make sure each package finishes installing without errors before continuing.
