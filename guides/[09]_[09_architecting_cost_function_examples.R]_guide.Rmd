...
1. Open `workshops/09_architecting_cost_function_examples.R` in the Source pane and skim the header comments for context.
...
7. When you are comfortable, run `source(file.path("workshops", "09_architecting_cost_function_examples.R"))` or click Source to execute the full workshop.
