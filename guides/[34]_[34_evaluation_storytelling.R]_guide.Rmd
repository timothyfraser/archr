...
1. Open `workshops/34_evaluation_storytelling.R` in the Source pane and skim the header comments for context.
...
7. When you are comfortable, run `source(file.path("workshops", "34_evaluation_storytelling.R"))` or click Source to execute the full workshop.
