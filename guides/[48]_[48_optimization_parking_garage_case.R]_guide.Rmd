...
1. Open `workshops/48_optimization_parking_garage_case.R` in the Source pane and skim the header comments for context.
...
7. Inspect the optimization configuration (population size, mutation rate) to see how they influence GA output.
8. When you are comfortable, run `source(file.path("workshops", "48_optimization_parking_garage_case.R"))` or click Source to execute the full workshop.
