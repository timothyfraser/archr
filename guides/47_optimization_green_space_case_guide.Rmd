...
**Learning Check 1.** What role does the helper `get_duration()` defined in Step 5 play in this workflow?
...
**Learning Check 2.** What role does the helper `get_cost()` defined in Step 6 play in this workflow?
...
**Learning Check 3.** What role does the helper `get_walkability()` defined in Step 7 play in this workflow?
...
**Learning Check 4.** What role does the helper `get_traveltimes()` defined in Step 8 play in this workflow?
