...
1. Open `workshops/47_optimization_green_space_case.R` in the Source pane and skim the header comments for context.
...
7. When you are comfortable, run `source(file.path("workshops", "47_optimization_green_space_case.R"))` or click Source to execute the full workshop.
