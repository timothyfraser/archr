...
1. Open `workshops/30_evaluation_probability_practice.R` in the Source pane and skim the header comments for context.
...
6. When you are comfortable, run `source(file.path("workshops", "30_evaluation_probability_practice.R"))` or click Source to execute the full workshop.
