...
1. Open `workshops/05_stakeholder_network_analysis_demo.R` in the Source pane and skim the header comments for context.
...
7. Recreate the plotted visuals and experiment with aesthetic mappings to reinforce each layer.
8. When you are comfortable, run `source(file.path("workshops", "05_stakeholder_network_analysis_demo.R"))` or click Source to execute the full workshop.
...
**Learning Check 5.** When the script produces a `ggplot`, what experiment can you run to understand the mapping between data and aesthetics?
