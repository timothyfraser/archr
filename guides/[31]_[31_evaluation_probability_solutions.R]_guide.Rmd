...
1. Open `workshops/31_evaluation_probability_solutions.R` in the Source pane and skim the header comments for context.
...
6. When you are comfortable, run `source(file.path("workshops", "31_evaluation_probability_solutions.R"))` or click Source to execute the full workshop.
