...
1. Open `workshops/50_optimization_multiobjective.R` in the Source pane and skim the header comments for context.
...
5. When you are comfortable, run `source(file.path("workshops", "50_optimization_multiobjective.R"))` or click Source to execute the full workshop.
