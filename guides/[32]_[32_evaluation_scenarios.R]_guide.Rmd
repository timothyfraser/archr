...
1. Open `workshops/32_evaluation_scenarios.R` in the Source pane and skim the header comments for context.
...
7. When you are comfortable, run `source(file.path("workshops", "32_evaluation_scenarios.R"))` or click Source to execute the full workshop.
