...
Step 1 installs GA and rmoo, so make sure each package finishes installing without errors before continuing.

</details>

**Learning Check 2.** What role does the helper `int2bit()` defined in Step 4 play in this workflow?
...
It creates `d1`. Create the object `d1` so you can reuse it in later steps.
