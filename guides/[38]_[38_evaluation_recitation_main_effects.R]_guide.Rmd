...
1. Open `workshops/38_evaluation_recitation_main_effects.R` in the Source pane and skim the header comments for context.
...
7. When you are comfortable, run `source(file.path("workshops", "38_evaluation_recitation_main_effects.R"))` or click Source to execute the full workshop.
