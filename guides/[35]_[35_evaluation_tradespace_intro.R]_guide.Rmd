...
1. Open `workshops/35_evaluation_tradespace_intro.R` in the Source pane and skim the header comments for context.
...
8. When you are comfortable, run `source(file.path("workshops", "35_evaluation_tradespace_intro.R"))` or click Source to execute the full workshop.
