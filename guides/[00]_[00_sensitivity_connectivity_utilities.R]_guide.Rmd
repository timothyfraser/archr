...
1. Open `workshops/00_sensitivity_connectivity_utilities.R` in the Source pane and skim the header comments for context.
...
5. When you are comfortable, run `source(file.path("workshops", "00_sensitivity_connectivity_utilities.R"))` or click Source to execute the full workshop.
