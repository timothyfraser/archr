...
1. Open `workshops/02_stakeholder_package_setup.R` in the Source pane and skim the header comments for context.
...
4. When you are comfortable, run `source(file.path("workshops", "02_stakeholder_package_setup.R"))` or click Source to execute the full workshop.
...
It emphasizes how r package installation checklist supports the overall systems architecting process in this course.
