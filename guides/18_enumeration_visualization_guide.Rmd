...
**Learning Check 1.** What role does the helper `get_percentages()` defined in Step 33 play in this workflow?
...
**Learning Check 2.** What role does the helper `get_viz()` defined in Step 55 play in this workflow?
...
**Learning Check 3.** Which libraries does Step 1 attach, and why do you run that chunk before others?

<details>
<summary>Show answer</summary>

It attaches dplyr, tidyr, ggplot2 and archr, ensuring their functions are available before you execute the downstream code.
...
It creates `arch` that enumerates architecture combinations with `archr` helpers. Get your full architectural space.
