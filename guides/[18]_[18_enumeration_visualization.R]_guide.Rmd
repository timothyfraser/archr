...
1. Open `workshops/18_enumeration_visualization.R` in the Source pane and skim the header comments for context.
...
8. When you are comfortable, run `source(file.path("workshops", "18_enumeration_visualization.R"))` or click Source to execute the full workshop.
